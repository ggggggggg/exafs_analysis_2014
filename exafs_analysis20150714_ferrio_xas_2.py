...
dir_p = "20150714_ferrio_500mM_xas_2"
...
# Write to files.
###########################################################
with open("20150714_2_pumped_hist_0.5ev_bin_blue_matter_cut.dat", 'w') as f:
    for e, c in zip((bins[1:] + bins[:-1])/2, pumped_hist_full):
        f.write("{0:.2f},{1:d}\n".format(e, int(c)))

with open("20150714_2_unpumped_hist_0.5ev_bin_blue_matter_cut.dat", 'w') as f:
