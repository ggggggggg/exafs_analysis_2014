...
dir_p = "20150721_500mM_ferrio_xas"
...
crate_unix_usecs, crate_frames = load_aux_file(os.path.join(dir_base, dir_p, "20150721_500mM_ferrio_xas"))
...
vega_badranges = find_badranges(vega_timestamps, vega_powers, threshold_power_hi=0.21, threshold_power_lo=0.165)
...
ax.set_title("20150713 500mM ferrioxalate with Blue power and Matter count cuts")
...
# Write to files.
###########################################################
with open("20150721_pumped_hist_0.5ev_bin_blue_matter_cut.dat", 'w') as f:
    for e, c in zip((bins[1:] + bins[:-1])/2, pumped_hist_full):
        f.write("{0:.2f},{1:d}\n".format(e, int(c)))

with open("20150721_unpumped_hist_0.5ev_bin_blue_matter_cut.dat", 'w') as f:
