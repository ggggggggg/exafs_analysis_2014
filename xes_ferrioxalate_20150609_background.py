...
dir_p = "201500611_ferrioxalate_260mM_50ps_delay_background_no_jet_not_cleaned"

dir_n = "201500609_ferrioxalate_260mM_50ps_delay_noise"
...
binsize=1
# pulse_timing.choose_laser(data, "laser",keep_size=0.014)
c,b = exafs.combined_energies_hist(data,binsize=binsize)

elapsed = ds.p_timestamp[-1]-ds.p_timestamp[0]
plt.figure()
plt.step(c,b)
plt.xlabel("energy (eV)")
plt.ylabel("counts per %0.2f eV bin"%binsize)
plt.title("elapsed %g"%elapsed)
