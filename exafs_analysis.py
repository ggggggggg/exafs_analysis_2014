...
dir_p = "20140084_ferrioxalate_pump_probe/"
dir_n = "20140084_ferrioxalate_pump_probe_noise/"
...
data.phase_correct2014(10, plot=True)
data.calibrate('p_filt_value_dc', ['VKAlpha', 'MnKAlpha', 'MnKBeta', 'FeKAlpha', 'CoKAlpha', 'CoKBeta', 'CuKAlpha', "FeKBeta", "VKBeta","CuKBeta","ScKAlpha","NiKAlpha"],
                        ...
                        excl=[],forceNew=True, max_num_clusters = 18, plot_on_fail=True, max_pulses_for_dbscan=1e5)
...
exafs.fit_edge_in_energy_combined(data, "FeKAlpha", doPlot=True)
